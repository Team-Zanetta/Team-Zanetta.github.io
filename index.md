...
### Deliverables
Click to view a list of all our deliverables in pdf format.
[Deliverables](./deliverables.md) <br>

### Additional
Additional information about the project: A document from early in the project detailing our major design decisions (much of which we were unable to implement), and a page of weekly snapshots (with meeting minutes included in pdf format).
